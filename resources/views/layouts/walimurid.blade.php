...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Wali Murid Dashboard') - Aplikasi Infaq</title>
    <meta name="viewport" content="width=device-width,initial-scale=1.0,user-scalable=0">

    <style>
        /* Tema Biru Muda - Layout Wali Murid */
        body {
            background: #f0f9ff;
        }
        ...
        <div id="sidebar">
            <div id="sidebar-scroll">
                <div class="sidebar-content">
                    <a href="{{ route('walimurid.dashboard') }}" class="sidebar-brand">
                    ...
                    {{-- MENU NAVIGASI UNTUK WALI MURID --}}
                    <ul class="sidebar-nav">
                        <li>
                            <a href="{{ route('walimurid.dashboard') }}" class="{{ request()->routeIs('walimurid.dashboard') ? 'active' : '' }}">
                                <i class="gi gi-home sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('walimurid.tagihan.index') }}" class="{{ request()->routeIs('walimurid.tagihan.*') ? 'active' : '' }}">
                                <i class="gi gi-money sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Tagihan Saya</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('admin-template/img/placeholders/avatars/avatar.jpg') }}" alt="avatar"> <i class="fa fa-angle-down"></i>
                        </a>
