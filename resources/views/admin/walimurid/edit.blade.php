...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-user-edit"></i>Edit Akun Wali Murid
        </h1>
    </div>
</div>
...
<div class="content">
    <div class="block">
        <div class="block-title">
            <h2><strong>Formulir Edit Wali Murid</strong></h2>
        </div>
        {{-- Form --}}
        {{-- Arahkan ke route update dengan ID wali murid --}}
        <form action="{{ route('admin.walimurid.update', $walimurid->id) }}" method="POST" class="form-horizontal form-bordered">
            @csrf
            ...
            <div class="form-group @error('name') has-error @enderror">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $walimurid->name) }}" required>
            ...
            <div class="form-group @error('username') has-error @enderror">
                ...
                <div class="col-md-6">
                    <input type="text" id="username" name="username" class="form-control" value="{{ old('username', $walimurid->username) }}" required>
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="password_confirmation">Konfirmasi Password Baru</label>
                <div class="col-md-6">
